...
director: Model = api.model('Режисер', {
    'id': fields.Integer(required=True, exemple=1),
    'name': fields.String(required=True, max_length=100, examlpe='Стив Энтин'),
...
auth: Model = api.model('Авторизация',{
    'emil': fields.String(required=True, example='test@test.com'),
